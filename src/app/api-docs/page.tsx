...
export const metadata: Metadata = {
  title: "API Documentation | SnapUrl",
  description: "API documentation for SnapUrl service",
};
...
export default function ApiDocsPage() {
  return (
    <div className="container mx-auto max-w-6xl px-4 pb-12 sm:px-6">
      ...
      <div className="mb-10 flex flex-col space-y-4 pt-4 text-center">
      ...
      <Tabs defaultValue="overview" className="w-full">
        <div className="mb-8 overflow-x-auto">
          <TabsList className="h-12 w-auto justify-start rounded-lg p-1">
            <TabsTrigger
              value="overview"
            ...
            <Card className="rounded-xl border shadow-sm">
              <CardHeader className="pb-2">
                ...
                <CardDescription className="text-base">
                  Learn about the SnapUrl API and how to get started.
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-8 pt-4">
                <div>
                  <h3 className="mb-3 text-lg font-medium">Base URL</h3>
                  <CodeBlock
                    code={`${DOMAIN}/api`}
                    language="text"
                ...
                <div>
                  <h3 className="mb-3 text-lg font-medium">Response Format</h3>
                ...
                <div>
                  <h3 className="mb-3 text-lg font-medium">Rate Limits</h3>
                  <p className="text-muted-foreground mb-3">
                    API requests are subject to rate limiting:
                  </p>
                  <ul className="text-muted-foreground mb-5 list-disc space-y-2 pl-6">
                    <li className="flex items-center gap-2">
                      <Badge className="mr-1">Authenticated</Badge> 100 requests
                      per 10 minutes
                    </li>
                    <li className="flex items-center gap-2">
...
X-RateLimit-Reset: 1698759340`}
            ...
            <Card className="rounded-xl border shadow-sm">
              ...
              <CardContent className="space-y-8 pt-4">
                <p className="text-muted-foreground text-lg">
                  The SnapUrl API uses API key-based authentication. You
                  need to include your API key in the Authorization header of
                  your requests.
                </p>
                ...
                <div className="rounded-lg border border-yellow-200 bg-yellow-50 p-5 text-yellow-800 dark:border-yellow-900 dark:bg-yellow-950/30 dark:text-yellow-300">
                  ...
                  <p className="text-sm">
                    Never expose your API keys in client-side code or public
                    repositories. Protect your API keys and use environment
              ...
              <CardContent className="space-y-8 pt-4">
                <div>
                  <div className="mb-4 flex items-center gap-3">
                    ...
                    <h3 className="text-lg font-medium">/api/shorten</h3>
                  </div>
  ...
  "customSlug": "my-custom-slug"  // Optional
                  ...
                  <h4 className="mt-6 mb-3 font-medium">Response</h4>
                  <CodeBlock
                    code={`{
  ...
  "createdAt": "2023-06-25T15:32:48.000Z"
                  ...
                  <h4 className="mt-6 mb-3 font-medium">Error Responses</h4>
          ...
          <TabsContent value="examples" className="mt-0">
            <Card className="rounded-xl border shadow-sm">
              <CardHeader className="pb-2">
                ...
                <CardDescription className="text-base">
                  Examples for using the SnapUrl API in different
                  languages
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-10 pt-4">
                <div>
                  <h3 className="mb-3 text-lg font-medium">cURL</h3>
                  <CodeBlock
...
shortenUrl('https://example.com/very-long-url')
  ...
  .catch(error => console.error(error));`}
                ...
                <div>
                  <h3 className="mb-3 text-lg font-medium">Python</h3>
                  <CodeBlock
...
try:
    ...
    print(str(e))`}
                ...
                <div>
                  <h3 className="mb-3 text-lg font-medium">iOS Shortcut</h3>
                  <p className="text-muted-foreground mb-4">
                    To use with iOS Shortcuts, create a new shortcut with the
                    following actions:
                  </p>
                  <ol className="text-muted-foreground mb-5 list-decimal space-y-3 pl-6">
                    <li>
                    ...
                    <li>
                      ...
                      <ul className="mt-2 list-disc space-y-2 pl-6">
                        ...
                        <li>
                          ...
                          YOUR_API_KEY&quot;, &quot;Content-Type&quot; =
                          &quot;application/json&quot;
                        </li>
                        <li>
                          Request Body: JSON with &quot;url&quot; key and the
                          URL you want to shorten (can use variables)
                        </li>
                      </ul>
                    </li>
                    <li>
                      Add a &quot;Get Dictionary Value&quot; action to extract
                      the &quot;shortUrl&quot; from the response
                    </li>
                    <li>
                  ...
                  <div className="bg-muted flex items-start gap-3 rounded-lg p-4">
                    ...
                    <div className="space-y-2 text-sm">
                      <p>
                        You can download a premade shortcut template from our
                      ...
                      <p className="text-primary font-medium">
                        ...
                        >
                          <span>
                            Download our ready-to-use SnapUrl iOS Shortcut
                          </span>
            ...
            <Card className="rounded-xl border shadow-sm">
              ...
              <CardContent className="space-y-8 pt-4">
                <div className="flex items-start gap-3">
                  <Package className="text-primary mt-1 h-8 w-8" />
                  <div>
                    <h3 className="mb-2 text-lg font-medium">npm Package</h3>
                    <p className="text-muted-foreground mb-4">
                      We provide an official npm package for shortening URLs
...
Short URL copied to clipboard!`}
                    ...
                    <table className="w-full border-collapse">
                      ...
                      <tbody className="divide-y">
                        ...
                        <tr className="hover:bg-muted/50">
                          ...
                          <td className="px-4 py-3 text-sm">
                            Your API key (can also be set via environment
                            variable)
                          </td>
                        </tr>
                        <tr className="hover:bg-muted/50">
                          <td className="px-4 py-3 text-sm">
                            <code>--endpoint, -e</code>
                          </td>
                          <td className="px-4 py-3 text-sm">
                            API endpoint (defaults to our official endpoint)
                          </td>
                        </tr>
                        <tr className="hover:bg-muted/50">
                          <td className="px-4 py-3 text-sm">
                          ...
                          <td className="px-4 py-3 text-sm">
                            Copy shortened URL to clipboard (defaults to true)
                          </td>
                        </tr>
                        <tr className="hover:bg-muted/50">
                          <td className="px-4 py-3 text-sm">
                ...
                <div>
                  ...
                  <ol className="text-muted-foreground mb-5 list-decimal space-y-2 pl-6">
                    <li>
                      Command line argument: <code>--api-key</code> or{" "}
                      <code>-k</code>
                    </li>
                    <li>
                      Environment variable: <code>SHORTURL_API_KEY</code>
                    </li>
                  </ol>
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      <h4 className="mb-2 font-medium">macOS/Linux:</h4>
                      <CodeBlock
                        code={
                  ...
                  <div className="mt-4 rounded-lg border border-blue-200 bg-blue-50 p-4 text-blue-800 dark:border-blue-900 dark:bg-blue-950/30 dark:text-blue-300">
                    <p className="text-sm">
                      Using the environment variable allows you to avoid
                      exposing your API key in command history or process
                      listings.
                    </p>
                  </div>
                </div>
